sap.ui.define(
	...
	function (
		...
		return Controller.extend("pavel.kliuiko.controller.SuppliersTable", {
			...
			/**
			 * "UpdateFinished" event handler of suppliers table.
			 *
			 * @param {sap.ui.base.Event} oEvent event object
			 */
			onSuppliersTableUpdateFinished: function (oEvent) {
				const iTotalItems = oEvent.getParameter("total");
				this.appViewModel.setProperty("/suppliersCount", iTotalItems);
			},
			...
			onSupplierTablePress: function (oEvent) {
				...
				const oCtx = oSource.getBindingContext("oDataModel");
